# (swig fork) 0.0.1 (2025-08-17)
- Added a new Swig autodoc parser. Currently only supports [autodoc feature](https://www.swig.org/Doc4.2/Python.html#Python_nn67) level 1
- Added a script, `gen_stub.py`, that generates python interface stub files (.pyi) with type hints parsed from a python module generated by swig
